      ...
      <Container>
        <Grid container alignItems="center" spacing={4} sx={{ pt: 0 }}>
          ...
          >
            ...
            >
              Upgrade Your Business Firm
            </Typography>
            <Typography variant="body1" color="black" sx={{ mb: 4 }} >
              Tempora class excepturi. Earum ipsam velit ex montes, explicabo ex
              adipisicing labore, fames quibusdam praesentium, nostrud eveniet,
              rutrum.
            </Typography>
        ...
        >
          ...
          >
            <CardContent>
              ...
              <Typography variant="subtitle1" fontWeight="bold" gutterBottom>
                {/* Empowering job seekers<br />with creative solutions. */}
                Passionate minds behind your success
              </Typography>
            </CardContent>
          </Card>
        </Box>
